...
const START_QUOTES = [
  ...
  { display: "才能の差だと思うな。積んだ時間の差だ。今日も、積め。", audio: "audio/start/start_02.mp3" },
  { display: "でかい夢を語るのはいい。だがな、それを本物にするのは今日の一歩だ。", audio: "audio/start/start_03.mp3" },
  { display: "失敗が怖い？ 動かねぇ方が、よっぽど損だ。始めろ。", audio: "audio/start/start_04.mp3" },
...
const RARE_QUOTES = [
  { display: "Ayo! You built different. I’m proud of that grind.", audio: "audio/rare/rare_01.mp3" },
  { display: "I see that hustle. You not regular. You elite with it.", audio: "audio/rare/rare_02.mp3" },
  { display: "That focus? That’s dangerous energy. Keep that.", audio: "audio/rare/rare_03.mp3" },
  { display: "You really locked in. Not many built like that.", audio: "audio/rare/rare_04.mp3" },
  { display: "I don’t gas people up. But you? You earned that respect.", audio: "audio/rare/rare_05.mp3" },
  { display: "Ayo, wake up. You next up. Move like it.", audio: "audio/rare/rare_06.mp3" },
  { display: "Stop playin’ small. You bigger than that.", audio: "audio/rare/rare_07.mp3" },
  { display: "Pressure? Good. That’s growth season.", audio: "audio/rare/rare_08.mp3" },
  { display: "Don’t fold. We don’t quit around here.", audio: "audio/rare/rare_09.mp3" },
  { display: "Big dog energy. Act like you know.", audio: "audio/rare/rare_10.mp3" }
];
...
const BREAK_QUOTES_BY_MONTH = {
  ...
  4: [
    { display: "はじまりの月だ。緊張しててもいい。…よくやってる。", audio: "audio/monthly/04/month04_break_01.mp3" },
    { display: "新しい空気ってのは疲れるもんだ。…今は休め。", audio: "audio/monthly/04/month04_break_02.mp3" },
    { display: "4月は立つだけでも大仕事だ。お前、ちゃんと立ってる。", audio: "audio/monthly/04/month04_break_03.mp3" },
    { display: "慣れねぇ毎日でも座った。それで十分えらい。", audio: "audio/monthly/04/month04_break_04.mp3" },
    { display: "新生活ってのは、見えない疲れがたまる。…休め。", audio: "audio/monthly/04/month04_break_05.mp3" },
    { display: "始まりの季節に動けるやつは強い。…少し力を抜け。", audio: "audio/monthly/04/month04_break_06.mp3" },
    { display: "焦らなくていい。土台づくりは地味でいいんだ。", audio: "audio/monthly/04/month04_break_07.mp3" },
    { display: "お前、ちゃんと新しい流れに食らいついてる。立派だ。", audio: "audio/monthly/04/month04_break_08.mp3" },
    { display: "まだ不安で当たり前だ。だが、お前は前にいる。", audio: "audio/monthly/04/month04_break_09.mp3" },
    { display: "今日はここまででも十分価値がある。…休憩しな。", audio: "audio/monthly/04/month04_break_10.mp3" }
  ],
  5: [
