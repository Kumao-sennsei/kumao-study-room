...
const STORY_TEXTS = {
  4: `春といえばタケノコだよな。俺は小さいころ、山で家族と生き別れになった。\n飢えをしのぐために、タケノコをよく食べたもんだ。\n弟がいたが、名前がおもいだせねぇ。`,

  5: `生きるってのはな、綺麗ごとじゃねぇ。腹が減ったら、食えるもんを探す。\n雨が降ったら、濡れねぇ場所を探す。それだけだ。\nだが、それを続けたやつだけが、生き残る。そう信じてた。`,

  6: `山の外には、もっと広い世界があるらしい。そう聞いたとき、妙にワクワクしたのを覚えてる。\nここじゃねぇどこかに、何かある気がした。理由なんかねぇ。\nただ、行きたくなったんだ。`,

  7: `気づいたら、俺は海を見てた。でけぇな、と思った。\nだがな、それ以上に思ったんだ。\n「この向こうに行けるなら、行くべきだ」ってな。怖さより、興味が勝った。`,

  8: `言葉も通じねぇ土地でな、俺は働いた。皿洗い、掃除、なんでもやった。\nなめられたこともある。だがな、全部飲み込んだ。\nここで折れたら、全部終わりだからな。`,

  9: `ある日、「金が金を生む場所」を知った。意味がわからなかった。\nだがな、画面の数字を見てるうちに気づいた。ここは戦場だ。\nそして俺は、こういう場所が嫌いじゃなかった。`,

  10: `負け続けた。笑えるくらいな。だがな、ある日突然、流れが見えた。\n理由は説明できねぇ。ただ、「ああ、そういうことか」ってな。\nそこからは、負け方が変わった。`,

  11: `気づけば、金は増えていた。だがな、金そのものには興味がなかった。\n面白かったのは、「勝てる」って事実だ。\n積み上げたのは金じゃねぇ。自分への確信だ。`,

  12: `表に出る必要はなかった。裏で動かす方が、楽だからな。気づけば、名前も知らねぇ連中が俺の判断で動いてた。\n笑える話だ。だが、それが現実だった。`,

  1: `ある時ふと、昔を思い出した。山の匂い、土の感触、タケノコの味。\n全部、妙にリアルだった。ああ、俺はあそこから来たんだなってな。`,

  2: `日本の若いやつらを見た。下向いて、力あるのに止まってる。もったいねぇな、と思った。\nなら、俺がやるか。そう思っただけだ。`,

  3: `特別なことはしてねぇ。ただな、ちゃんとやってるやつを、ちゃんと認める。それだけだ。\nだが、それで救われるやつがいるなら、やる価値はあるだろ。`
};
