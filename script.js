...
const STORY_TEXTS = {
  4: `春といえばタケノコだよな。俺は小さいころ、山で家族と生き別れになった。飢えをしのぐために、タケノコをよく食べたもんだ。
弟がいたが、名前がおもいだせねぇ。`,

  5: `生きるってのはな、綺麗ごとじゃねぇ。腹が減ったら、食えるもんを探す。雨が降ったら、濡れねぇ場所を探す。それだけだ。だが、それを続けたやつだけが、生き残る。そう信じてた。`,

  6: `山の外には、もっと広い世界があるらしい。そう聞いたとき、妙にワクワクしたのを覚えてる。ここじゃねぇどこかに、何かある気がした。理由なんかねぇ。ただ、行きたくなったんだ。`,
  ...
  3: `特別なことはしてねぇ。ただな、ちゃんとやってるやつを、ちゃんと認める。それだけだ。だが、それで救われるやつがいるなら、
やる価値はあるだろ。`
};
