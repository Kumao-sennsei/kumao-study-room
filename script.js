...
const START_QUOTES = [
  ...
  { display: "本気のやつは、派手じゃねぇ。\n黙って積む。お前も、そっち側に来い。", audio: "audio/start/start_09.mp3" },
  ...
  { display: "やる気を待つな。先に手を動かせ。\n気分は、あとからついてくる。", audio: "audio/start/start_26.mp3" },
  { display: "負けたくねぇなら、積め。\n悔しいなら、積め。\n結局それしかねぇ。", audio: "audio/start/start_27.mp3" },
